...
var GridItem = /*#__PURE__*/function (_React$Component) {
  ...
  function GridItem() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onDragStart", function (e, _ref) {
      ...
      var transformScaleW = typeof transformScale === 'number' ? transformScale : transformScale.w;
      var transformScaleH = typeof transformScale === 'number' ? transformScale : transformScale.h;
      var cLeft = clientRect.left / transformScaleW;
      var pLeft = parentRect.left / transformScaleW;
      var cTop = clientRect.top / transformScaleH;
      var pTop = parentRect.top / transformScaleH;
...
_defineProperty(GridItem, "propTypes", {
  ...
  transformScale: _propTypes.default.oneOfType([_propTypes.default.number, _propTypes.default.shape({
